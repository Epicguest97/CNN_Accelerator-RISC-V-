...
VL_ATTR_COLD void Vcnn_accelerator___024root___eval_static__TOP(Vcnn_accelerator___024root* vlSelf);
...
VL_ATTR_COLD void Vcnn_accelerator___024root___eval_static(Vcnn_accelerator___024root* vlSelf) {
    ...
    // Body
    Vcnn_accelerator___024root___eval_static__TOP(vlSelf);
...
VL_ATTR_COLD void Vcnn_accelerator___024root___eval_static__TOP(Vcnn_accelerator___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcnn_accelerator___024root___eval_static__TOP\n"); );
    Vcnn_accelerator__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
#endif
            VL_FATAL_MT("top_tb.v", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vcnn_accelerator___024root___stl_sequent__TOP__0(Vcnn_accelerator___024root* vlSelf);
...
VL_ATTR_COLD void Vcnn_accelerator___024root___eval_stl(Vcnn_accelerator___024root* vlSelf) {
    ...
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vcnn_accelerator___024root___stl_sequent__TOP__0(vlSelf);
        Vcnn_accelerator___024root____Vm_traceActivitySetAll(vlSelf);
    }
}

VL_ATTR_COLD void Vcnn_accelerator___024root___stl_sequent__TOP__0(Vcnn_accelerator___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcnn_accelerator___024root___stl_sequent__TOP__0\n"); );
    Vcnn_accelerator__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
